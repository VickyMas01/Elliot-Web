        ...
        <div className='formContainer'>
          ...
          <div id='introduction' className='intro_vis'>
           ...
           <h2 className='introDescr'>Here you can choose among 3 different loading strategies,
             ...
             <button id='start' className='start' onClick={start}>Let's start !</button>
          </div>

            <div id='strategy' className='strat_no'>
                <h2 className='titleSt'>Loading strategy</h2>
                <button id='op1' className={choice==='dataset'?'strOpt_selected':'strOpt'} value='dataset' onClick={setStrategyChoice}>Dataset</button>
                <button id='op2' className={choice==='fixed'?'strOpt_selected':'strOpt'} value='fixed' onClick={setStrategyChoice}>Fixed</button>
                <button id='op3' className={choice==='hierarchy'?'strOpt_selected':'strOpt'} value='hierarchy' onClick={setStrategyChoice}>Hierarchy</button>
                <span id='error'/>
